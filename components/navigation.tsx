...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#1A1A1A]/90 backdrop-blur-sm border-b border-[#00FFFF]/20">
            ...
            <li key={item.id}>
              <button
                ...
                className={`relative font-mono text-sm transition-colors ${
                  activeSection === item.id ? "text-[#00FFFF]" : "text-gray-400 hover:text-white"
                }`}
              >
                {item.label}
